...
module.exports = cds.service.impl(async function () {
    ...
    this.after("READ", Risks, (data) => {
        ...
        // Looping through the array of risks to set the virtual field 'criticality' that you is defined in the schema
        risks.forEach((risk) => {
    ...
    this.on("READ", Risks, async (req, next) => {
         ...
         * As this is not possible, the risk entity and the business partner enitity are in different systems (SAP BTP and S/4 HANA Cloud),
         * if the is such an expand, remove it.
         */
